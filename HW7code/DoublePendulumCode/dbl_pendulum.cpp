...
V = -m g l  cos(th1) = - m g l ( cos(th1) + cos(th2))
...
int main()
{
  ...
  char filename[512];
  sprintf(filename, "Trace_th1=%4.2f_th2=%4.2f_v1=%4.2f_v2=%4.2f_tmax=%8.6f_dt=%8.6f_tsample=%8.6f.dat",th1, th2,v1,v2,tmax,dt,tpr);
  ...
  V=-m*g*l*(2*cos(th1)+cos(th2));
  E=K+V;
  printf("Final energy:  %f  Error energty:  %f  \n\n",E, E - Einitial);
